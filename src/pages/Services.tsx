...
export default function Services() {
  const mainServices = [
    ...
    },
    {
      ...
      description: 'Continuous support to ensure your success and growth.',
    },
    {
      icon: BarChart,
      title: 'Performance Analysis',
      description: 'In-depth analytics to track and optimize your business metrics.',
    },
    {
      icon: Users,
      title: 'Team Training',
      description: 'Comprehensive training programs to upskill your workforce.',
    },
    {
      icon: Zap,
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              A full suite of services to address every aspect of your business needs
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {packages.map((pkg, index) => (
              <Card
                key={index}
                className={pkg.featured ? 'border-blue-600 border-2 shadow-lg' : ''}
              >
                <CardHeader>
                  {pkg.featured && (
              ...
              {[
                {
                  step: '01',
                  title: 'Discovery',
                  description: 'We start by understanding your business, goals, and challenges through comprehensive consultations.',
                },
                {
                  step: '02',
                  title: 'Strategy',
                ...
                },
                {
                  step: '03',
                  title: 'Implementation',
                  description: 'We work alongside you to execute the strategy, ensuring smooth integration and minimal disruption.',
                },
                {
                  step: '04',
                  title: 'Optimization',
                  description: 'Continuous monitoring and refinement to maximize results and adapt to changing conditions.',
                },
              ].map((item, index) => (
                <div key={index} className="flex gap-6">
                  <div className="text-6xl font-bold text-blue-600 text-opacity-20 flex-shrink-0">
                    {item.step}
                  </div>
                  <div>
